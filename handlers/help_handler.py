...
def setup(app):
    async def help_cmd(update, context):
        ...
        await update.message.reply_text(
            ...
            f"{'─' * 30}\n"
            "\n<b>Setup Awal</b>\n"
            "• /login — hubungkan akun via OTP untuk channel/grup private\n"
            ...
            "  <i>Link public bisa dipakai tanpa /login.</i>\n\n"
            ...
            "<b>Media Sosial</b>\n"
            "• <code>/get &lt;link&gt;</code> — YouTube, TikTok, Instagram,\n"
            "  Facebook, X/Twitter, dan Threads (link publik, tanpa login)\n"
            ...
            "<b>🤖 Fitur AI</b>\n"
            "• /faceswap — tukar wajah di foto (kirim 2 foto)\n"
            "• /imagine &lt;prompt&gt; — buat gambar dari teks\n"
            "  <code>→ /imagine a dragon flying over Tokyo at sunset</code>\n\n"
            f"{'─' * 30}\n"
